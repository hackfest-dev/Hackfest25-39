...
const ProcessingCalculator = () => {
  ...
  const calculateEmissions = () => {
    ...
    const coalWashedValue = parseFloat(inputs.coalWashed) || 0;

    const electricityCO2 = electricityValue * emissionFactors.electricity;
    const fugitiveCO2e = coalWashedValue * emissionFactors.fugitiveCH4 * emissionFactors.gwpCH4;

    return {
      total: electricityCO2 + fugitiveCO2e,
      breakdown: {
        electricity: electricityCO2,
        fugitive: fugitiveCO2e
      },
      inputs: {
        electricity: electricityValue,
        coalWashed: coalWashedValue
      }
    };
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formData.append('sector_type', 'Processing');
      ...
      setInputs({ electricity: '', coalWashed: '' });
      setEmissions(null);
      setPdfFile(null);
  ...
  return (
    <div className="calculator-container">
      <h2>Coal Processing & Handling Sector Calculator</h2>
      ...
      <div className="input-section">
        ...
        <div className="input-group">
          <label>
            ...
            <input
              type="number"
              value={inputs.coalWashed}
              onChange={(e) => setInputs({...inputs, coalWashed: e.target.value})}
              placeholder="Enter coal washed quantity"
              min="0"
              step="0.1"
            />
          </label>
      ...
      <div className="action-buttons">
        {!emissions ? (
          <button 
            ...
            disabled={!inputs.electricity && !inputs.coalWashed}
          >
            Calculate Emissions
          </button>
        ) : (
      ...
      {emissions && (
        <div className="results-section">
          ...
          <div className="results-breakdown">
            ...
            <div className="result-item">
              <span className="result-label">Fugitive Emissions:</span>
              <span className="result-value">
                {emissions.breakdown.fugitive.toFixed(2)} kg CO₂e
              </span>
            </div>
      ...
      <div className="emission-factors">
        ...
        <ul>
          ...
          <li>
            Fugitive CH₄: {emissionFactors.fugitiveCH4} kg/tonne × GWP {emissionFactors.gwpCH4}
          </li>
        </ul>
      </div>
    </div>
